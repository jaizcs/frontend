...
function Plan({
	...
	return (
		...
		>
			...
			>
				<Logomark
					className={clsx('h-6 w-6 flex-none', logomarkClassName)}
				/>
			...
			<Container>
				<div className="mx-auto max-w-2xl text-center">
					...
					<p className="mt-2 text-lg text-gray-600">
						Whether you’re one person trying to get ahead or a big
						firm trying to take over the world, we’ve got a plan for
						you.
					</p>
				</div>
